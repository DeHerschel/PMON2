   ...
   <div class="max-w-7xl mx-auto">
        <div class="max-w-7xl py-2 sm:px-6 lg:px-8 mx-auto">
            <div class="md:grid md:grid-cols-4 md:gap-2">
                ...
                <div class="col-span-3 lg:col-span-2 h-100 grid grid-cols-1  bg-white sm:p-4 shadow sm:rounded-tl-md sm:rounded-tr-md">
                    @livewire('pinggraphic')
                </div>
                <div class="col-span-1 grid grid-cols-1 bg-white sm:p-6 shadow sm:rounded-tl-md sm:rounded-tr-md">
                    <div class="col-span-1 h-5 text-black font-normal text-center">
                         Port Scan
                    @if ($nmap == null)
                        <svg role="status" class=" mx-auto mt-5 col span-1 my-auto self-center w-8 h-8 text-gray-200 animate-spin dark:text-gray-200 fill-blue-500" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
